    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu") || body.startsWith("বট") || body.startsWith("জান") || body.startsWith("জানু") || body.startsWith("বাবু")) {
            ...
            const rawReplies = [
              ...
              "_আমার বস Ayan এর মন খারাপ 🥺","_ বট বট করিস না আমার বস singel মেয়েদের সাথে বিজি 😶🥂",
              "তুই কি Wi-Fi? কাছে এলেই কানেকশন হারায়া ফেলি 😵",
              "Hmm bolo 🐹",
              "_বট বট না করে আমার বস Ayan রে মেসেজ দে 🐸",
              "এতো ডাকাডাকি করস কেন 😾",
              "Ayan ke i love u bolo taholey amake paba pio",
              "Yes 🐣",
              "তুই পড়তে না বসে যদি আরেকটা মেসেজ দিস... তাহলে তুই গরু 🐄🤓",
              "I am here 💅",
              "Amar boss ayan er pokho theke ummmmmmmmmmah😘",
              "hae bolo Jan pakhi 🎀✨",
              "হ্যাঁ টুনটুনি বলো 🤭","আমি তোরে সাহায্য করতে পারবো না কারণ তুই অনেক পচা!!😬","_আমাকে না ডেকে আমার বস Ayan কে ডাক দে😝","আমাকে এত ডাকিস কেন!🐥","hae bolo Jan pakhi","হুম বলো না বাবু 🥺",
