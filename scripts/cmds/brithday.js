module.exports = {
  ...
  onStart: async function ({ api, event }) {
    ...
    // ১. টার্গেট আইডি এবং নাম নির্ধারণ (রিপ্লাই অথবা মেনশন)
    if (messageReply) {
      targetID = messageReply.senderID;
      // রিপ্লাই থেকে নাম সংগ্রহ করা অনেক সময় কঠিন হতে পারে, তাই ডিফল্ট 'প্রিয়' রাখা হয়েছে অথবা ডাটাবেস থেকে নেওয়া যায়।
      name = "প্রিয়"; 
    } else if (Object.keys(mentions).length > 0) {
      targetID = Object.keys(mentions)[0];
      name = mentions[targetID].replace("@", "");
    } else {
      return api.sendMessage("🎂 আপনি কাকে শুভেচ্ছা জানাতে চান? তাকে মেনশন করুন অথবা তার মেসেজে রিপ্লাই দিন! 🥰", threadID, messageID);
    }
    ...
    // ২. শুভেচ্ছা বার্তার তালিকা
    const messages = [
      { delay: 0, msg: `বস আয়ান এর পক্ষ থেকে তোমাকে জন্মদিনের শুভেচ্ছা, @${name}!\n🎉 HAPPY BIRTHDAY 🎉` },
    ...
    try {
      ...
      console.error(error);
      api.sendMessage("❌ বার্তা পাঠাতে সমস্যা হয়েছে!", threadID);
    }
  }
};